...
- **AI 원탁 토론:** 전용 창을 열어 지정한 주제로 Claude Code, Codex, Antigravity가 여러 라운드에 걸쳐 토론하게 할 수 있습니다. 참여자, 각자 사용할 모델, 라운드 수를 직접 선택할 수 있으며 시작 전에 token 예상치가 표시됩니다. 이미지 첨부와 읽기 전용 프로젝트 폴더도 지원되어 참여자가 실제 파일을 참조할 수 있습니다.
